...
interface CameraScannerModalProps {
  ...
  quickCodes?: Array<{ label: string; code: string; hint?: string }>;
}
...
export const CameraScannerModal: React.FC<CameraScannerModalProps> = ({
  ...
  const sampleBarcodes = quickCodes && quickCodes.length > 0 ? quickCodes : defaultSampleBarcodes;
